...
export default function RootLayout({
  ...
  return (
    <html lang="en" data-scroll-behavior="smooth" className="overflow-x-clip" suppressHydrationWarning>
      ...
      <body className={`${inter.className} antialiased bg-white dark:bg-navy-900 text-navy-800 dark:text-slate-100 transition-colors duration-300 overflow-x-clip min-h-screen w-full relative`}>
        <a
          href="#main-content"
