    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Book Appointment — Gorakhpur Mission Rehab Neuro Rehabilitation",
      },
    ],
  },
  twitter: {
  ...
  return (
    <>
      ...
      <main id="main-content" className="pt-0">
        <section className="pt-12 md:pt-20 pb-12 md:pb-16 bg-slate-50 dark:bg-navy-950 overflow-hidden relative transition-colors">
