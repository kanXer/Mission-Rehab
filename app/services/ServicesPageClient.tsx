  ...
  return (
    <>
      ...
      <main id="main-content" className="pt-0">
        <section className="pt-12 md:pt-20 pb-12 md:pb-20 bg-slate-50 dark:bg-navy-950 overflow-hidden relative transition-colors">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <ScrollReveal>
              <div className="text-center mb-10">
                ...
                <h1 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold text-navy-900 dark:text-white mb-4 tracking-tight">
