...
const sortOptions = [
  ...
  { label: "Name Zâ€“A", value: "name_za" },
  { label: "Subject Aâ€“Z", value: "sub_az" },
  { label: "Subject Zâ€“A", value: "sub_za" },
]
                ...
                <div className="flex items-start justify-between mb-2">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      {e.email && e.email !== "-" && e.email !== "—" && <p className="text-sm text-slate-400 dark:text-slate-500">{e.email}</p>}
                    </div>
                  </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4" onClick={() => setSelected(null)}>
          <div className="bg-white dark:bg-navy-800 rounded-2xl max-w-lg w-full p-6 shadow-2xl border border-slate-200 dark:border-navy-700 relative" onClick={e => e.stopPropagation()}>
            ...
            <div className="space-y-3 text-sm">
              ...
              {selected.message && selected.message !== "-" && selected.message !== "—" && (
